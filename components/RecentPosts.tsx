...
// Featured post card with embedded Instagram reel
const FeaturedPostCard = () => (
  <div className="flex-shrink-0 w-[326px] relative group overflow-hidden border-2 border-[#C8A96E] bg-[#111111] hover:border-[#dab896] transition-colors duration-300 rounded-lg">
    {/* Featured badge */}
    <div className="absolute top-3 left-3 z-10 bg-[#C8A96E] text-black text-[10px] font-bold uppercase tracking-wider px-2 py-1 rounded">
      Featured
    </div>

    {/* Embedded Instagram Reel */}
    <iframe
      src="https://www.instagram.com/reel/DYH4GueRFJD/embed"
